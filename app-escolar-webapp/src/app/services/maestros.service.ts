...
export class MaestrosService {
  ...
  public validarMaestro(data: any, editar: boolean){
    ...
    // Solo validar materias_json si no se está editando (registro nuevo)
    // En edición, permitir que esté vacío si el maestro ya tenía materias
    if(!editar){
      ...
      } else if(!Array.isArray(data["materias_json"]) || data["materias_json"].length === 0){
