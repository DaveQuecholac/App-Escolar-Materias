...
import { AdvertenciaActualizarMateriaModalComponent } from './modals/advertencia-actualizar-materia-modal/advertencia-actualizar-materia-modal.component';
import { AdvertenciaActualizarUsuarioModalComponent } from './modals/advertencia-actualizar-usuario-modal/advertencia-actualizar-usuario-modal.component';
...
@NgModule({
  declarations: [
    ...
    AdvertenciaActualizarMateriaModalComponent,
    AdvertenciaActualizarUsuarioModalComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
